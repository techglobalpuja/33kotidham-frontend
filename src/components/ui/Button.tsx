...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({ 
  ...
  const variants = {
    primary: 'bg-[#f37335] text-white hover:bg-[#d84f0d] active:bg-[#d84f0d] focus:ring-[#f37335]',
    secondary: 'bg-gray-200 text-gray-800 hover:bg-gray-300 active:bg-gray-400 focus:ring-gray-300',
    outline: 'border border-[#f37335] text-[#f37335] bg-transparent hover:bg-[#fff3ee] active:bg-[#ffefe9] focus:ring-[#f37335]',
    ghost: 'text-[#f37335] bg-transparent hover:bg-[#fff3ee] active:bg-[#ffefe9] focus:ring-[#f37335]',
