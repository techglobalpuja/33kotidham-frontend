...
const NewCheckoutError = ({ error, reset }: { error: Error; reset: () => void }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-purple-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center border border-orange-100">
        ...
        <h2 className="text-2xl font-bold text-gray-900 font-['Philosopher'] mb-4">Something Went Wrong!</h2>
        <p className="text-gray-600 mb-6">
          We encountered an issue while preparing your checkout. Please try again.
        </p>
...
export default NewCheckoutError;