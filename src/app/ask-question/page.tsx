        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-[20px] sm:text-[22px] md:text-[24px] font-normal leading-[32px] sm:leading-[34px] md:leading-[36px] font-['Lato'] max-w-5xl mx-auto text-gray-700 mb-12">
              Get personalized guidance from our expert astrologers and spiritual consultants.
              <br className="hidden sm:block" />
              Ask any question about your life, career, relationships, or spiritual journey.
            </p>
          </div>
        </div>
      </section>
