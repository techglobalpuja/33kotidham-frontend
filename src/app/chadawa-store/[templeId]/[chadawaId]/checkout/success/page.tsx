        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Your chadawa offering has been successfully confirmed. May the divine blessings be with you!
            </p>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 mb-6 border border-orange-100">
              ...
              <div className="flex items-start gap-6">
                <div className="relative w-32 h-32 rounded-lg overflow-hidden flex-shrink-0">
                  <Image
                    src={constructImageUrl(booking.temple.image_url)}
                    alt={booking.temple.name}
                    fill
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 text-sm mb-3 leading-relaxed">
                    {booking.temple.description}
                  </p>
                  <div className="flex items-center gap-2 text-orange-600">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                    <span className="font-medium">{booking.temple.location}</span>
                  </div>
                  <div className="mt-3 bg-orange-50 rounded-lg p-3">
                    <p className="text-xs text-gray-500 font-medium mb-1">Gotra</p>
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex items-start gap-4 flex-1">
                          <div className="relative w-20 h-20 rounded-lg overflow-hidden flex-shrink-0">
                            <Image
                              src={constructImageUrl(bc.chadawa.image_url)}
                              alt={bc.chadawa.name}
                              fill
                              className="object-cover"
                              unoptimized={true}
                              onError={(e) => {
                                const target = e.target as HTMLImageElement;
                                target.src = 'https://placehold.co/600x400/orange/white?text=Chadawa';
                              }}
                            />
                          </div>
                          <div className="flex-1">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">You will receive a confirmation message on WhatsApp with complete details within 15 minutes</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  <p className="font-semibold text-gray-900 mb-1">Offering at Temple</p>
                  <p className="text-gray-600 text-sm">Your chadawa will be offered at the temple on your behalf with complete rituals</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  <p className="font-semibold text-gray-900 mb-1">Prasad Delivery</p>
                  <p className="text-gray-600 text-sm">Blessed prasad will be delivered to your address within 7-10 business days</p>
                </div>
              </li>
            </ul>
          </div>
...
export default ChadawaCheckoutSuccessPage;
