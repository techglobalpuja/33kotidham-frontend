...
export async function POST(request: NextRequest) {
    try {
        ...
        const apiUrl = new URL('https://api.prokerala.com/v2/astrology/chart');
        ...
        apiUrl.searchParams.append('chart_type', chartType);
        apiUrl.searchParams.append('chart_style', chartStyle);
