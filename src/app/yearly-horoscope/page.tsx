...
const YearlyHoroscopePage: React.FC = () => {
  ...
  const handleZodiacClick = () => {
    // In a real app, this would navigate to a specific yearly horoscope for that sign
    // router.push(`/yearly-horoscope/${_zodiacId}`);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50/30 via-pink-50/40 to-purple-50/30 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-20 w-72 h-72 bg-rose-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-6000"></div>
      </div>
      ...
      <section className="relative w-full min-h-screen pt-20 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-br from-rose-100/40 via-pink-50/50 to-purple-100/60"></div>
          <div className="absolute inset-0 bg-gradient-to-r from-rose-200/30 via-pink-100/40 to-purple-200/50 animate-gradient-x"></div>
          
          {/* Ethnic Pattern Overlay */}
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-10 left-10 w-32 h-32 border-2 border-rose-400 rounded-full animate-spin-slow"></div>
            <div className="absolute top-20 right-20 w-20 h-20 border border-pink-500 rounded-full animate-pulse"></div>
            <div className="absolute bottom-20 left-20 w-24 h-24 border-2 border-purple-300 rotate-45 animate-float"></div>
            <div className="absolute bottom-10 right-10 w-16 h-16 border border-pink-400 rounded-full animate-twinkle"></div>
          </div>
          
          {/* Sacred Mandala Pattern */}
          <div className="absolute inset-0 opacity-5">
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96">
              <div className="w-full h-full border-8 border-rose-400 rounded-full animate-spin-slow"></div>
              <div className="absolute inset-8 border-4 border-pink-500 rounded-full animate-pulse"></div>
              <div className="absolute inset-16 border-2 border-purple-300 rounded-full"></div>
            </div>
          </div>
        </div>
              ...
              <div className="w-full max-w-4xl mx-auto text-center">
                <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                  ...
                  <div className="mb-8 relative flex justify-center">
                    <div className="p-8 rounded-full bg-white/20 backdrop-blur-lg border-2 border-rose-300/40 relative overflow-hidden group shadow-lg">
                      <div className="absolute inset-0 bg-gradient-to-br from-rose-200/20 to-pink-200/20 rounded-full group-hover:scale-110 transition-transform duration-500"></div>
                      <div className="text-6xl text-rose-600 relative z-10 animate-float font-bold" style={{fontFamily: 'serif'}}>ॐ</div>
                      {/* Subtle glow effect */}
                      <div className="absolute inset-0 bg-rose-300/10 rounded-full blur-xl group-hover:bg-rose-300/20 transition-all duration-500"></div>
                    </div>
                  </div>
                  ...
                  <p className="text-[18px] sm:text-[20px] md:text-[22px] font-normal leading-[28px] sm:leading-[30px] md:leading-[32px] font-['Lato'] max-w-4xl mb-10 text-gray-700 mx-auto">
                    Discover your yearly cosmic guidance rooted in ancient Vedic traditions. 
                    <br className="hidden sm:block" />
                    Unlock personalized insights for the year ahead and your zodiac sign.
                  </p>
                  
                  {/* Enhanced Traditional CTA Buttons */}
                  <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
                    <button className="group relative px-10 py-4 bg-gradient-to-r from-rose-400 to-pink-400 text-white font-bold text-lg rounded-full overflow-hidden transition-all duration-500 hover:scale-105 shadow-lg hover:shadow-xl">
                    ...
                    <button 
                      ...
                      className="group relative px-10 py-4 bg-white/80 backdrop-blur-sm text-rose-600 font-bold text-lg rounded-full border-2 border-rose-300 hover:border-rose-400 transition-all duration-500 hover:scale-105 shadow-md hover:shadow-lg"
                    >
                      <span className="relative z-10 flex items-center justify-center gap-3">
                        <div className="text-xl">🏠</div>
                        Back to Home
      ...
      <section className="relative w-full py-[80px] sm:py-[90px] md:py-[100px] px-[42px] sm:px-[49px] md:px-[56px] bg-gradient-to-br from-white/80 to-rose-50/50">
        <div className="w-full max-w-[1440px] mx-auto">
          {/* Section Header */}
          <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="mb-6">
              <span className="inline-block px-6 py-2 bg-gradient-to-r from-rose-100 to-pink-100 text-rose-700 rounded-full text-sm font-semibold mb-4">
            ...
            <p className="text-[18px] sm:text-[20px] md:text-[22px] font-normal leading-[28px] sm:leading-[30px] md:leading-[32px] text-gray-600 font-['Lato'] max-w-3xl mx-auto">
              Choose your zodiac sign to receive personalized yearly predictions and cosmic guidance
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {horoscopeData.map((zodiac, index) => (
              ...
              >
                {/* Main Card Container */}
                <div className="relative bg-white/90 backdrop-blur-lg rounded-3xl p-8 shadow-2xl hover:shadow-rose-500/25 transition-all duration-700 border border-white/50 overflow-hidden group-hover:bg-white">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <div className="relative mb-6 flex justify-center">
                      <div className="relative">
                        {/* Icon container */}
                        <div className={`relative w-20 h-20 rounded-full bg-gradient-to-br ${zodiac.color} p-1 shadow-xl group-hover:shadow-rose-500/50 transition-all duration-500 group-hover:rotate-12`}>
                    ...
                    {/* Zodiac Info */}
                    <h3 className="text-[22px] sm:text-[24px] font-bold text-gray-800 font-['Philosopher'] mb-2 group-hover:text-rose-700 transition-colors duration-300 transform group-hover:scale-105">
                      {zodiac.name}
                    </h3>
      ...
      {/* Yearly Horoscope Insights Section */}
      <section className="relative w-full py-[80px] sm:py-[90px] md:py-[100px] px-[42px] sm:px-[49px] md:px-[56px] bg-gradient-to-br from-purple-50/50 to-rose-50/50">
        <div className="w-full max-w-[1440px] mx-auto">
          <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="mb-6">
              <span className="inline-block px-6 py-2 bg-gradient-to-r from-purple-100 to-rose-100 text-purple-700 rounded-full text-sm font-semibold mb-4">
                🌟 Yearly Predictions
              </span>
            </div>
            <h2 className="text-[42px] sm:text-[48px] md:text-[56px] font-bold leading-[48px] sm:leading-[54px] md:leading-[64px] text-gray-800 font-['Philosopher'] mb-6">
              <span className="bg-gradient-to-r from-purple-600 via-pink-600 to-rose-600 bg-clip-text text-transparent">
                Twelve Months of Cosmic Guidance
              </span>
            </h2>
            <p className="text-[18px] sm:text-[20px] md:text-[22px] font-normal leading-[28px] sm:leading-[30px] md:leading-[32px] text-gray-600 font-['Lato'] max-w-3xl mx-auto">
              Unlock the celestial wisdom that guides your year ahead
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className={`group bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/50 transition-all duration-700 hover:shadow-2xl hover:-translate-y-2 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ animationDelay: '600ms' }}>
              ...
              <p className="text-gray-600 font-['Lato'] leading-relaxed">
                This year brings transformative opportunities for deeper emotional connections. Single signs may encounter meaningful encounters, especially during the spring months. Those in relationships should focus on quality time together. Communication is key to resolving any misunderstandings. Express appreciation for your partner&apos;s support throughout the year.
              </p>
            </div>
            ...
            <div className={`group bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/50 transition-all duration-700 hover:shadow-2xl hover:-translate-y-2 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ animationDelay: '800ms' }}>
              ...
              <p className="text-gray-600 font-['Lato'] leading-relaxed">
                Professional matters gain significant momentum this year. A proposal or project may reach a crucial decision point during the summer months. Financial planning should be prioritized, especially towards the end of the year. Unexpected opportunities may arise for those in creative or communication fields. Networking events could prove particularly beneficial.
              </p>
            </div>
            ...
            <div className={`group bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/50 transition-all duration-700 hover:shadow-2xl hover:-translate-y-2 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ animationDelay: '1000ms' }}>
              ...
              <p className="text-gray-600 font-['Lato'] leading-relaxed">
                Prioritize holistic wellness this year. Physical activity will boost your energy levels significantly. Pay attention to your diet and hydration, especially during the middle months. Meditation or yoga can help center your thoughts during busy periods. Listen to your body&apos;s signals and rest when needed. Mental well-being requires extra attention this year.
              </p>
            </div>
          </div>
          ...
          <div className={`text-center mt-16 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="bg-gradient-to-r from-rose-500/10 to-purple-500/10 rounded-3xl p-8 border border-rose-200/50 backdrop-blur-sm">
              <h3 className="text-[28px] sm:text-[32px] font-bold text-gray-800 font-['Philosopher'] mb-4">
                Ready for Your Personalized Yearly Horoscope?
              </h3>
              <p className="text-gray-600 font-['Lato'] mb-8 max-w-2xl mx-auto">
                Get detailed predictions tailored specifically to your zodiac sign and birth chart for deeper insights into your year ahead.
              </p>
              <button className="group relative px-8 py-4 bg-gradient-to-r from-rose-500 to-purple-500 text-white font-bold text-lg rounded-full overflow-hidden transition-all duration-500 hover:scale-105 shadow-lg hover:shadow-xl">
                <span className="relative z-10 flex items-center justify-center gap-3">
                  <div className="text-xl">🔮</div>
                  Get Your Detailed Yearly Horoscope
                </span>
