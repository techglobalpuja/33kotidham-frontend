        ...
        <div className="w-full max-w-[1200px] mx-auto">
          <div className="flex flex-col gap-8 text-left">
            ...
            <div className="terms-section">
              ...
              <p className="text-[14px] sm:text-[16px] md:text-[18px] font-normal leading-[22px] sm:leading-[24px] md:leading-[28px] text-[#333333]  mt-4">
            ...
            <div className="terms-section">
              ...
              <div className="mb-6">
                <h3 className="text-[20px] sm:text-[22px] md:text-[24px] font-bold leading-[24px] sm:leading-[26px] md:leading-[28px] text-[#111111]  mb-3">
                ...
                <ul className="list-disc ml-6 space-y-2 text-[14px] sm:text-[16px] md:text-[18px] font-normal leading-[22px] sm:leading-[24px] md:leading-[28px] text-[#333333]  mt-4">
            ...
            <div className="terms-section">
              ...
              <p className="text-[14px] sm:text-[16px] md:text-[18px] font-normal leading-[22px] sm:leading-[24px] md:leading-[28px] text-[#333333]  mb-4">
              ...
              <ul className="list-disc ml-6 space-y-2 text-[14px] sm:text-[16px] md:text-[18px] font-normal leading-[22px] sm:leading-[24px] md:leading-[28px] text-[#333333] ">
            ...
            <div className="terms-section border-t pt-6">
              <p className="text-[14px] sm:text-[16px] md:text-[18px] font-normal leading-[22px] sm:leading-[24px] md:leading-[28px] text-[#666666]  italic">
